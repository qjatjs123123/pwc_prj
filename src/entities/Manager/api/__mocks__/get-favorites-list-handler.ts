...
export const favoritesHandler = [
  http.get(`${baseUrl}/favorites`, ({ request }) => {
    ...
    const allItems = [
      ...
      { id: 4, company_name: '카카오', created_at: '2025-11-12T10:20:45.987654' },
      { id: 5, company_name: '네이버', created_at: '2025-11-12T11:15:30.111222' },
      { id: 6, company_name: 'SK', created_at: '2025-11-12T12:00:00.333444' },
      { id: 7, company_name: '포스코', created_at: '2025-11-12T12:45:10.555666' },
      { id: 8, company_name: 'KT', created_at: '2025-11-12T13:30:20.777888' },
      { id: 9, company_name: 'LG화학', created_at: '2025-11-12T14:15:30.999000' },
      { id: 10, company_name: '한화', created_at: '2025-11-12T15:00:40.121314' },
